...
public class SnowFlake {
    ...
    private static final float INCREMENT_UPPER = 2.5f;
    ...
    public static SnowFlake create(int width, int startY,int endY, Paint paint) {
        RandomGenerator random = new RandomGenerator();
        int x = random.getRandom(width);
        int y = random.getRandom(startY,endY);
